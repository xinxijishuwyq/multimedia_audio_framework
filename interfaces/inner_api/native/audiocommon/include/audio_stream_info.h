...
enum AudioChannelSet: uint64_t {
    ...
    TOP_CENTER = 1ULL << 11U,
    TOP_FRONT_LEFT = 1ULL << 12U, TOP_FRONT_RIGHT = 1ULL << 13U, TOP_FRONT_CENTER = 1ULL << 14U,
    TOP_BACK_LEFT = 1ULL << 15U, TOP_BACK_RIGHT = 1ULL << 16U, TOP_BACK_CENTER = 1ULL << 17U,
    ...
    BOTTOM_FRONT_LEFT = 1ULL << 38U, BOTTOM_FRONT_RIGHT = 1ULL << 39U, BOTTOM_FRONT_CENTER = 1ULL << 40U
};
...
enum AudioChannelLayout: uint64_t {
    ...
    /** Channel count: 10*/
    CH_LAYOUT_5POINT1POINT4 = CH_LAYOUT_5POINT1_BACK | TOP_FRONT_LEFT | TOP_FRONT_RIGHT | TOP_BACK_LEFT |TOP_BACK_RIGHT,
...
const std::vector<AudioChannelLayout> RENDERER_SUPPORTED_CHANNELLAYOUTS {
    CH_LAYOUT_UNKNOWN, CH_LAYOUT_MONO, CH_LAYOUT_STEREO,
