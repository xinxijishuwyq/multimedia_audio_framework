...
private:
    ...
    using BluetoothA2dpAudioSrcObserverFunc = ErrCode (BluetoothA2dpAudioSrcObserverStub::*)(MessageParcel &data,
        MessageParcel &reply);
    std::map<uint32_t, BluetoothA2dpAudioSrcObserverFunc> memberFuncMap_;

    DISALLOW_COPY_AND_MOVE(BluetoothA2dpAudioSrcObserverStub);
};
}  // namespace Bluetooth
}  // namespace OHOS
#endif // OHOS_BLUETOOTH_A2DP_AUDIO_SRC_OBSERVER_STUB_H
