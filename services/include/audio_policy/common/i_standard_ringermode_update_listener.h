...
#ifndef I_STANDARD_AUDIO_RINGERMODE_UPDATE_LISTENER_H
#define I_STANDARD_AUDIO_RINGERMODE_UPDATE_LISTENER_H
...
#endif // I_STANDARD_AUDIO_RINGERMODE_UPDATE_LISTENER_H
