...
enum class AudioPolicyInterfaceCode {
    ...
    REGISTER_SPATIALIZATION_ENABLED_EVENT,
    REGISTER_HEAD_TRACKING_ENABLED_EVENT,
    UNREGISTER_SPATIALIZATION_ENABLED_EVENT,
    UNREGISTER_HEAD_TRACKING_ENABLED_EVENT,
    ...
    AUDIO_POLICY_MANAGER_CODE_MAX = UNREGISTER_SPATIALIZATION_STATE_EVENT,
};
} // namespace AudioStandard
} // namespace OHOS
