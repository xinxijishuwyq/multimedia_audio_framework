...
{
    MEDIA_DEBUG_LOG("[PolicyManager] ConnectToPulseAudio++");
    ...
    pa_proplist_sets(proplist, PA_PROP_APPLICATION_ID, "org.huawei.pulseaudio.service");
...
void PulseAudioPolicyManager::InitVolumeMap(void)
{
