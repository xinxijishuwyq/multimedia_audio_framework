    ...
    std::unique_ptr<RendererPeriodPositionJsCallback> &jsCb)
{
    ...
    CHECK_AND_RETURN_LOG(env_ != nullptr, "RendererPeriodPositionCallbackNapi: OnJsRendererPeriodPositionCallback: env_ is null");
    ...
    CHECK_AND_RETURN_LOG(work != nullptr, "RendererPeriodPositionCallbackNapi: OnJsRendererPeriodPositionCallback: No memory");
