...
describe("AudioRendererInterruptSyncUnitTest", function() {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_001', 0, async function (done) {
        ...
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        ...
        render2.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_005', 0, async function (done) {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_006', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MUSIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_007', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MUSIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_008', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MUSIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_009', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MUSIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_010', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MUSIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    // VOICE_CALL
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_011', 0, async function (done) {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_012', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_CALL'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_013', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_CALL'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_014', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_CALL'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_015', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['VOICE_CALL'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_016', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_CALL'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_017', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_CALL'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_018', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_CALL'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_019', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_CALL'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_020', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_CALL'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    // RINGTONE
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_021', 0, async function (done) {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_022', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['RINGTONE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_023', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['RINGTONE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_024', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['RINGTONE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_025', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['RINGTONE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_026', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['RINGTONE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_027', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['RINGTONE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_028', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['RINGTONE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_029', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['RINGTONE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_030', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['RINGTONE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    // VOICE_ASSISTANT
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_031', 0, async function (done) {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_032', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_ASSISTANT'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_033', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_ASSISTANT'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_034', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_ASSISTANT'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_035', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['VOICE_ASSISTANT'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_036', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_ASSISTANT'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_037', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_ASSISTANT'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_038', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_ASSISTANT'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_039', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_ASSISTANT'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_040', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['VOICE_ASSISTANT'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    // ULTRASONIC
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_041', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_042', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['ULTRASONIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_043', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['ULTRASONIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_044', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['ULTRASONIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_045', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ULTRASONIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_046', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['ULTRASONIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_047', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['ULTRASONIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_048', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['ULTRASONIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_049', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['ULTRASONIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_050', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['ULTRASONIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    // ALARM
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_051', 0, async function (done) {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_052', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ALARM'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_053', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ALARM'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_054', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ALARM'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_055', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['ALARM'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_056', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ALARM'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_057', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ALARM'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_058', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ALARM'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_059', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ALARM'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_060', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ALARM'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    // ACCESSIBILITY
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_061', 0, async function (done) {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_062', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ACCESSIBILITY'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_063', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ACCESSIBILITY'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_064', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ACCESSIBILITY'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_065', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['ACCESSIBILITY'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_066', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ACCESSIBILITY'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_067', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ACCESSIBILITY'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_068', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ACCESSIBILITY'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_069', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ACCESSIBILITY'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_070', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['ACCESSIBILITY'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        await start(render1, done)
