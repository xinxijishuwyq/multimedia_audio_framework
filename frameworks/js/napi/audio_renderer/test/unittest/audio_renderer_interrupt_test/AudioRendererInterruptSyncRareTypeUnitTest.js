...
describe("AudioRendererInterruptSyncRareTypeUnitTest", function() {
    ...
    // SPEECH
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_071', 0, async function (done) {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_072', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['SPEECH'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_073', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['SPEECH'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_074', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['SPEECH'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_075', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['SPEECH'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
            console.log("75.eventAction=" + JSON.stringify(eventAction))
        ...
        render2.on("audioInterrupt", async(eventAction) => {
            console.log("75_2.eventAction=" + JSON.stringify(eventAction))
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_076', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['SPEECH'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_077', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['SPEECH'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_078', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['SPEECH'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_079', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['SPEECH'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_080', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['SPEECH'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    // MOVIE
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_081', 0, async function (done) {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_082', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MOVIE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_083', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MOVIE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_084', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MOVIE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_085', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['MOVIE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
            console.log("85.eventAction=" + JSON.stringify(eventAction))
            render1_callback = true
        })
        await start(render1, done)
        ...
        render2.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render2.on("audioInterrupt", async(eventAction) => {
            console.log("85_2.eventAction=" + JSON.stringify(eventAction))
            render2_callback = true
        })
        await start(render2, done)
        await sleep(500)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_086', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MOVIE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_087', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MOVIE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_088', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MOVIE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_089', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MOVIE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_090', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['MOVIE'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    // UNKNOW
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_091', 0, async function (done) {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_092', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['UNKNOW'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_093', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['UNKNOW'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_094', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['UNKNOW'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_095', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['UNKNOW'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
            console.log("95.eventAction=" + JSON.stringify(eventAction))
            render1_callback = true
        })
        await start(render1, done)
        ...
        render2.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render2.on("audioInterrupt", async(eventAction) => {
            console.log("95_2.eventAction=" + JSON.stringify(eventAction))
            render2_callback = true
        })
        await start(render2, done)
        await sleep(500)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_096', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['UNKNOW'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_097', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['UNKNOW'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_098', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['UNKNOW'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_099', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['UNKNOW'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_100', 0, async function (done) {
        let render1 = await createAudioRenderer(renderInfo['UNKNOW'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
        render1.on("audioInterrupt",async (eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_101', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['MUSIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.SHARE_MODE)
        render1.on("audioInterrupt", async(eventAction) => {
        ...
        let render2 = await createAudioRenderer(renderInfo['MUSIC'], streamInfo['48000'])
        render2.setInterruptModeSync(audio.InterruptMode.SHARE_MODE)
        render2.on("audioInterrupt", async(eventAction) => {
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_102', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['MUSIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.SHARE_MODE)
    ...
    it('SUB_AUDIO_RENDERER_INTERRUPT_SYNC_TEST_103', 0, async function (done) {
        let render1_callback = false
        let render2_callback = false
        let render1 = await createAudioRenderer(renderInfo['MUSIC'], streamInfo['44100'])
        render1.setInterruptModeSync(audio.InterruptMode.INDEPENDENT_MODE)
