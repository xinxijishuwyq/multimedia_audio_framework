 ...
 */
#ifndef NAPI_AUDIO_RENDERER_OUTPUT_DEVICE_CHANGE_CALLBACK_H
#define NAPI_AUDIO_RENDERER_OUTPUT_DEVICE_CHANGE_CALLBACK_H
...
#endif // NAPI_AUDIO_RENDERER_OUTPUT_DEVICE_CHANGE_CALLBACK_H
