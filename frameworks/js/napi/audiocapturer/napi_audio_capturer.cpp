...
void NapiAudioCapturer::RegisterCapturerReadDataCallback(napi_env env, napi_value *argv, const std::string &cbName,
    NapiAudioCapturer *napiCapturer)
{
    CHECK_AND_RETURN_LOG(napiCapturer->capturerReadDataCallbackNapi_ == nullptr, "writeData already subscribed.");
    ...
    CHECK_AND_RETURN_LOG(napiCapturer->capturerReadDataCallbackNapi_ != nullptr, "writeDataNapi_ is nullptr");
    ...
    NapiAudioCapturer *napiCapturer)
{
    ...
    AUDIO_INFO_LOG("UnregisterCapturerReadDataCallback is successfule");
}
} // namespace AudioStandard
} // namespace OHOS
