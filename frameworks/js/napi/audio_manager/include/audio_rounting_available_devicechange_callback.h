...
#ifndef AUDIO_ROUTING_AVAILABLE_DEVICECHANGE_CALLBACK_NAPI_H_
#define AUDIO_ROUTING_AVAILABLE_DEVICECHANGE_CALLBACK_NAPI_H_
...
class AudioRountingAvailableDeviceChangeCallbackNapi : public AudioManagerAvailableDeviceChangeCallback {
public:
    explicit AudioRountingAvailableDeviceChangeCallbackNapi(napi_env env);
    virtual ~AudioRountingAvailableDeviceChangeCallbackNapi();
...
#endif // AUDIO_ROUTING_AVAILABLE_DEVICECHANGE_CALLBACK_NAPI_H_