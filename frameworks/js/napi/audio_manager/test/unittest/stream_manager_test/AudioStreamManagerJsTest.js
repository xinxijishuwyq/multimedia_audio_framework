...
describe("AudioStreamManagerJsTest", function () {
  ...
  /*
   * @tc.name:getCurrentAudioCapturerInfoArraySync001
   * @tc.desc:Get getCurrentAudioCapturerInfoArraySync
   * @tc.type: FUNC
   * @tc.require: I7V04L
   */
  it("getCurrentAudioCapturerInfoArraySync001", 0, async function (done) {
    ...
    try {
      ...
      console.error(`${TAG} getCurrentAudioCapturerInfoArraySync001 ERROR: ${e.message}`);
      expect().assertFail();
      done();
      return;
    }
    ...
    try {
      let audioCapturerInfos = audioStreamManager.getCurrentAudioCapturerInfoArraySync();
      console.info("getCurrentAudioCapturerInfoArraySync001:"+JSON.stringify(audioCapturerInfos));
      expect(audioCapturerInfos.length).assertLarger(0);
      expect(audioCapturerInfos[0].deviceDescriptors[0].displayName!==""
        && audioCapturerInfos[0].deviceDescriptors[0].displayName!==undefined).assertTrue();

      await audioCapturer.release();
      done();
    } catch (err) {
      console.error(`${TAG} getCurrentAudioCapturerInfoArraySync001 ERROR: ${JSON.stringify(err)}`);
      expect(false).assertTrue();
      await audioCapturer.release();
      done();
      return;
  ...
  /*
   * @tc.name:getCurrentAudioCapturerInfoArraySync002
   * @tc.desc:Get getCurrentAudioCapturerInfoArraySync
   * @tc.type: FUNC
   * @tc.require: I7V04L
   */
  it("getCurrentAudioCapturerInfoArraySync002", 0, async function (done) {
    ...
    try {
      ...
      console.error(`${TAG} getCurrentAudioCapturerInfoArraySync002 ERROR: ${e.message}`);
      expect().assertFail();
      await audioCapturer.release();
      done();
      return;
    ...
    try {
      let audioCapturerInfos = audioStreamManager.getCurrentAudioCapturerInfoArraySync();
      console.info("AudioCapturerChangeInfoArray++++:"+JSON.stringify(audioCapturerInfos));
      expect(audioCapturerInfos.length).assertLarger(0);
      expect(audioCapturerInfos[0].deviceDescriptors[0].displayName!==""
        && audioCapturerInfos[0].deviceDescriptors[0].displayName!==undefined).assertTrue();
      ...
      console.error(`${TAG} getCurrentAudioCapturerInfoArraySync002 ERROR: ${JSON.stringify(err)}`);
      expect(false).assertTrue();
      await audioCapturer.release();
      done();
    }
  ...
  /*
   * @tc.name:getCurrentAudioCapturerInfoArraySync003
   * @tc.desc:Get getCurrentAudioCapturerInfoArraySync
   * @tc.type: FUNC
   * @tc.require: I7V04L
   */
  it("getCurrentAudioCapturerInfoArraySync003", 0, async function (done) {
    let audioCapturer = null;
    let audioStreamManager = null;
    ...
    try {
      ...
      await audioCapturer.release();
      audioCapturerInfos = audioStreamManager.getCurrentAudioCapturerInfoArraySync();
      expect(audioCapturerInfos.length).assertEqual(0);
      done();
    } catch(e) {
      console.error(`${TAG} getCurrentAudioCapturerInfoArraySync003 ERROR: ${e.message}`);
      expect().assertFail();
      await audioCapturer.release();
      done();
      return;
