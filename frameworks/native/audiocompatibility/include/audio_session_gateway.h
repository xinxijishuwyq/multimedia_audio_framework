...
#ifndef AUDIO_SESSION_GATEWAY_H
#define AUDIO_SESSION_GATEWAY_H
...
class AudioSessionGateway : public AudioContainerBase {
public:
...
private:
    AudioSessionGateway *CreateSession(SessionType eSession);
};
} // namespace AudioStandard
} // namespace OHOS
#endif // AUDIO_SESSION_GATEWAY_H
