...
public:
    ...
    explict AudioRendererSinkInner(const std::string halName = "primary");
...
static int32_t SetOutputPortPin(DeviceType outputDevice, AudioRouteNode &sink)
{
    ...
    switch (outputDevice) {
        ...
        case DEVICE_TYPE_USB_ARM_HEADSET:
            sink.ext.device.type = PIN_OUT_USB;
            sink.ext.device.desc = (char *)"pin_out_usb";
            break;
